...
#define COLUMN_IS_COMPLETE @"is_complete"
...
#define STMT_TABLE_DEFINITION_WORD_LIST (@"INSERT INTO " TABLE_DEFINITION_WORD_LIST @" (" COLUMN_WORD_ID @"," COLUMN_DEFINITION @") values (?, ?);")
...
#define STMT_TABLE_MNEMONICS_WORD_LIST (@"INSERT INTO " TABLE_MNEMONICS_WORD_LIST @" (" COLUMN_WORD_ID @"," COLUMN_MNEMONICS  @") values (?, ?);")
...
#define STMT_TABLE_SENTENCE_WORD_LIST (@"INSERT INTO " TABLE_SENTENCE_WORD_LIST @" (" COLUMN_DEFINITION_ID @"," COLUMN_SENTENCE @") values (?, ?);")
...
#define STMT_TABLE_SYNONYM_WORD_LIST (@"INSERT INTO " TABLE_SYNONYM_WORD_LIST @" (" COLUMN_DEFINITION_ID @"," COLUMN_SYNONYM @") values (?, ?);")
